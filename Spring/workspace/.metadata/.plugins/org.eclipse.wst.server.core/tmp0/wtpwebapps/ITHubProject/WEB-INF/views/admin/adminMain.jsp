							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									...
									<div class="tags-sec full-width">
										<ul>
											<li><a href="${contextPath }/admin/adminServiceCenter" title="">Help Center</a></li>
							...
							<div class="col-lg-6 col-md-8 no-pd">
								...
								<div align="center">
									<c:if test="${paging.prev }">
										<a href="${contextPath }/adminMain.go?page=${paging.begin - 1}&type=${param.type}&word=${param.word}">[이전]</a>	<!-- 검색 했을 때 타입, 입력값 넘어감 -->
									</c:if>
									<c:forEach var="i" begin="${paging.begin }" end="${paging.end }" step="1">
										<c:choose>
											...
											<c:otherwise>
												<a href="${contextPath }/adminMain.go?page=${i}&type=${param.type}&word=${param.word}">[${i }]</a>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									<c:if test="${paging.next }">
										<a href="${contextPath }/adminMain.go?page=${paging.end + 1}&type=${param.type}&word=${param.word}">[다음]</a>
									</c:if>
								</div>
							</div>
