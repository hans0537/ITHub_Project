...
function check(f) {
	...
	if(f.mEmail.value === ""){
		...
		check = confirm("한번만 다시 생각 해보실래요...?");
		if(!check) return false;

		check = confirm("아 진짜 마지막...");
		if(!check) return false;

		check = confirm("아 오케이 그대를 보내드리죠....");
		if(!check) return false;
								...
								<div class="tab-pane fade show active" id="nav-acc" role="tabpanel" aria-labelledby="nav-acc-tab">
			                     ...
			                     <div class="row">
							  	...
							  	<div class="tab-pane fade" id="nav-deactivate" role="tabpanel" aria-labelledby="nav-deactivate-tab">
							  		<div class="acc-setting">
										<h3>회원 탈퇴 하기</h3>
										<form action="${contextPath }/member/delete" method="post" onsubmit="return check(this)">
											<div class="cp-field">
												<h5>Email</h5>
												<div class="cpp-fiel">
											...
											<div class="save-stngs pd3">
												<ul>
													<li><button type="submit">회원 탈퇴 하기</button></li>
