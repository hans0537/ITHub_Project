...
//    });
    ...
    $(".close-box-cancel").on("click", function(){
    	$("#pText").val("");
        $("#overview-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    ...
    $("#intro-open").on("click", function(){
    	$("#intro-box").addClass("open");
    	$(".wrapper").addClass("overlay");
    	return false;
    });
    $(".close-box").on("click", function(){
    	$("#intro-box").removeClass("open");
    	$(".wrapper").removeClass("overlay");
    	return false;
    });
    ...
    //  ============= CHANGE BACKPIC FUNCTION ==========
    $("#changeBackpic").on("click", function(){
        $("#changeBack-pic").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#changeBack-pic").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
