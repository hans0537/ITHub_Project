							...
							<div class="tab-content" id="nav-tabContent">
							  	<div class="tab-pane fade active show" id="nav-deactivate" role="tabpanel" aria-labelledby="nav-deactivate-tab">
							  		<div class="acc-setting">
										...
										<form action="${contextPath }/qna/qnaWrite" method="post" enctype="multipart/form-data">
											<input type="hidden" name="mqnaState" value = "0">
											<div class="cp-field">
												<h5>제목</h5>
												<input type = "text" name ="mqnaTitle">
											</div>
											<div class="cp-field">
												<h5>내용</h5>
												<textarea id="summernote" class="summernote" name="mqnaContent"></textarea>
											</div>
											...
											<div class="save-stngs pd3">
												<ul>
													<li><button type="submit">QnA 올리기</button></li>
