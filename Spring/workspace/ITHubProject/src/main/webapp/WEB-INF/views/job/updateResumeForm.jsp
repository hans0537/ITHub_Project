            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="innerbody apply-jobbox">
                        <h3>지원 양식</h3>
                        <form action = "${contextPath}/job/updateResume" method = "post"  enctype = "multipart/form-data" onsubmit="return check(this)">
                        	...
                        	<input type="text" name="posName" value="${jdto.posName }"> 
                            <input type="text"  value = "${dto.mLastname}${dto.mFirstname}"><br>
