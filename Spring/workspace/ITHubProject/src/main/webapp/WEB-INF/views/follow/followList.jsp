							...
							<c:if test="${list.mSeq == dto.mSeq }">
								<div class="col-lg-3 col-md-4 col-sm-6">
									<div class="company_profile_info">
										...
										<a href="${contextPath }/member/profile" class="view-more-pro">View Profile</a>
									...
									<div class="company_profile_info">
										<div class="company-up-info">
											...
											<ul>
												...
												<c:choose>
													<c:when test="${user == 'me'}">
														<li><a href="${contextPath }/member/memunFollow?mSeq=${list.mSeq}&path=fw&user=${user}&cSeq=${cSeq}" title="" class="follow" style="background-color: gray;">Following</a></li>
													</c:when>
													<c:otherwise>
														...
														<c:choose>
															...
															<c:otherwise>
																<li><a href="${contextPath }/member/memFollow?mSeq=${list.mSeq}&path=fw&user=${user}&cSeq=${cSeq}" title="" class="follow">Follow</a></li>
															</c:otherwise>
														</c:choose>
							...
							<c:if test="${list.mSeq == dto.mSeq }">
								<div class="col-lg-3 col-md-4 col-sm-6">
									<div class="company_profile_info">
										...
										<a href="${contextPath }/page/myPage?pSeq=${list.pSeq}" class="view-more-pro">View Profile</a>
									</div><!--company_profile_info end-->
								</div>
							</c:if>
									...
									<div class="company_profile_info">
										<div class="company-up-info">
											...
											<ul>
												...
												<c:choose>
													<c:when test="${user == 'me' }">
														<li><a href="${contextPath }/page/pageunFollow?pSeq=${list.pSeq}&pType=${list.pType}&path=fw&user=${user}&cSeq=${cSeq}" title="" class="follow" style="background-color: gray;">Following</a></li>
													</c:when>
													<c:otherwise>
														<c:choose>
															<c:when test="${check == -1}">
															...
															<c:otherwise>
																<li><a href="${contextPath }/page/pageFollow?pSeq=${list.pSeq}&pType=${list.pType}&path=fw&user=${user}&cSeq=${cSeq}" title="" class="follow">Follow</a></li>
															</c:otherwise>
														</c:choose>
													</c:otherwise>
												</c:choose>
