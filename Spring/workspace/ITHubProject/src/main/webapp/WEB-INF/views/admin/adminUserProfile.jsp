...
<body>
	...
	<%@ include file="/WEB-INF/views/layout/adminNav.jsp" %>
		<section class="cover-sec">
			<c:choose>
				<c:when test="${otherDto.mBackpic == null }">
					<img src="${contextPath}/resources/images/resources/cover-img.jpg" alt="">
				</c:when>
				<c:otherwise>
					<img width="1600px" height="400px" src="${contextPath }/resources/upload/${otherDto.mBackpic}" alt="???">
				</c:otherwise>
			</c:choose>
								...
								<div class="main-left-sidebar">
									...
									<div class="user_profile">
										...
										<div class="user-pro-img">
											<c:choose>
												<c:when test="${otherDto.mPic == null }">
													<img src="${contextPath}/resources/images/resources/cover-img.jpg" alt="">
												</c:when>
												<c:otherwise>
													<img height="180px" width="180px" src="${contextPath }/resources/upload/${otherDto.mPic}" alt="어디갔노">
												</c:otherwise>
											</c:choose>
										</div><!--user-pro-img end-->

										<div class="user-tab-sec">
											<h3>${otherDto.mLastname }${otherDto.mFirstname }</h3>
										</div>
								
								
										<div class="user_pro_status">
											<ul class="flw-status">
												<li style="cursor: pointer;" onclick="location.href='${contextPath}/follow/followList?user=other&mp=m&cSeq=${otherDto.mSeq}'">
													<span>Following</span>
													<b>${otherDto.following }</b>
												</li>
												<li style="cursor: pointer;" onclick="location.href='${contextPath}/follow/followerList?user=other&mp=m&cSeq=${otherDto.mSeq}'">
													<span>Followers</span>
													<b>${otherDto.follower }</b>
												</li>
											</ul>
									...
									<div class="user-tab-sec rewivew">
											...
											<ul>
												...
												<li data-tab="saved-jobs">
													<a href="#" title="">
														<img src="${contextPath}/resources/images/ic4.png" alt="">
														<span>Jobs</span>
													</a>
												</li>
												<li data-tab="my-bids">
													<a href="#" title="">
														<img src="${contextPath}/resources/images/ic5.png" alt="">
														<span>Bids</span>
													</a>
												</li>
												...
												<li data-tab="rewivewdata">
													<a href="#" title="">
														<img src="${contextPath}/resources/images/review.png" alt="">
														<span>Reviews</span>
													</a>
												</li>
												<li data-tab="payment-dd">
													<a href="#" title="">
														<img src="${contextPath}/resources/images/ic6.png" alt="">
														<span>Payment</span>
													</a>
												</li>
                                            ...
                                            <div class="tab-pane fade" id="cadidates" role="tabpanel" aria-labelledby="cadidates-tab">
                                                <div class="post-bar">
                                                    <div class="post_topbar applied-post">
                                                        <div class="usy-dt">
                                                            <img src="${contextPath}/resources/images/resources/us-pic.png" alt="">
                                                            <div class="usy-name">
                                                                <h3>${otherDto.mLastname}${otherDto.mFirstname }</h3>
                                                                <div class="epi-sec epi2">
                                                                    <ul class="descp descptab bklink">
                                                                        <li><img src="${contextPath}/resources/images/icon8.png" alt=""><span>Epic Coder</span></li>
                                                                        <li><img src="${contextPath}/resources/images/icon9.png" alt=""><span>India</span></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
									...
									<div class="product-feed-tab current" id="feed-dd">
										<div class="posts-section">
											<div class="post-bar">
												<div class="post_topbar">
													<div class="usy-dt">
														...
														<div class="usy-name">
															<h3>John Doe</h3>
															<span><img src="${contextPath}/resources/images/clock.png" alt="">3 min ago</span>
														</div>
													</div>
													<div class="ed-opts">
														<a href="#" title="" class="ed-opts-open"><i class="la la-ellipsis-v"></i></a>
											...
											<div class="post-bar">
												...
												<div class="epi-sec">
													<ul class="descp">
														<li><img src="${contextPath}/resources/images/icon8.png" alt=""><span>Front End Developer</span></li>
														<li><img src="${contextPath}/resources/images/icon9.png" alt=""><span>India</span></li>
													</ul>
													<ul class="bk-links">
														<li><a href="#" title=""><i class="la la-bookmark"></i></a></li>
											...
											<div class="post-bar">
												<div class="post_topbar">
													<div class="usy-dt">
														<img src="${contextPath}/resources/images/resources/us-pc2.png" alt="">
														<div class="usy-name">
															<h3>John Doe</h3>
															<span><img src="${contextPath}/resources/images/clock.png" alt="">3 min ago</span>
														</div>
		...
		<div class="overview-box" id="changeBack-pic">
			<div class="overview-edit">
				...
				<form action="${contextPath }/member/backPic" method="post" enctype="multipart/form-data">
		...
		<div class="overview-box" id="change-image">
			<div class="overview-edit">
				...
				<form action="${contextPath }/member/mPic" method="post" enctype="multipart/form-data">
		...
		<div class="overview-box" id="intro-box">
			<div class="overview-edit">
				...
				<form action="${contextPath }/member/introUpdate" method="post">
					<input type="text" name="mIntro" placeholder="${otherDto.mIntro }" />
					<button type="submit" class="save">Save</button>
					<button type="reset" class="cancel">Reset</button>
				</form>
				<a href="#" title="" class="close-box"><i class="la la-close"></i></a>
