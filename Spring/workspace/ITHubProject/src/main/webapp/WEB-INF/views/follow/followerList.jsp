											...
											<ul>
												...
												<c:choose>
													<c:when test="${user == 'me' }">
														<c:choose>
															<c:when test="${check == -1}">
																<li><a href="${contextPath }/member/memunFollow?mSeq=${list.mSeq}&path=fr&user=${user}&mp=${mp}&cSeq=${cSeq}" title="" class="follow" style="background-color: gray;">Following</a></li>
															</c:when>
															<c:otherwise>
																<li><a href="${contextPath }/member/memFollow?mSeq=${list.mSeq}&path=fr&user=${user}&mp=${mp}&cSeq=${cSeq}" title="" class="follow">Follow</a></li>
															</c:otherwise>
														</c:choose>
													</c:when>
													<c:otherwise>
